...
## Where to Shop — Denver / Littleton Area

### Bulk Aggregate, Sand & Base Materials
| Supplier | What for | Notes |
|----------|----------|-------|
| **Pioneer Sand** (multiple Denver metro locations) | Class 6 aggregate, concrete sand | Local Colorado aggregate supplier; sells by the yard |
| **A-1 Organics** (Eaton, CO — delivers metro) | Topsoil, compost, mulch | Colorado-based, bulk delivery |
| **Timberline Landscaping Supply** (Littleton area) | Aggregate, sand, topsoil, mulch | Local; worth calling for bulk pricing |
| **Lowe's / Home Depot** (Littleton) | Bagged aggregate/sand if bulk order is too large | More expensive per unit but no delivery minimum |

### Flagstone & Natural Stone
| Supplier | Notes |
|----------|-------|
| **Colorado Materials** (Denver) | Broad selection of Colorado sandstone, flagstone |
| **Western Colorado Stone** | Flagstone pallets; delivers |
| **Pioneer Sand** | Also carries decorative stone |
| **Home Depot / Lowe's** | Limited flagstone selection but convenient for small fill orders |

### Concrete Pavers
| Supplier | Notes |
|----------|-------|
| **Home Depot** | Carries Pavestone and HDG brands; 24"×24" slabs often in stock |
| **Lowe's** | Similar range; check in-store stock before ordering online |
| **Belgard dealers** (search belgard.com/find-a-dealer) | Premium pavers; wider style/color selection |
| **MSI Surfaces** (Denver distributor) | Large format pavers, pallet orders |

### Irrigation & Plumbing Supplies
| Supplier | Notes |
|----------|-------|
| **Ewing Irrigation** (multiple Denver metro locations) | Pro-grade irrigation; carries Hunter, Rain Bird; open to public |
| **Home Depot / Lowe's** | Good for PVC fittings, conduit, drip kits |
| **SprinklerWarehouse.com** | Online; best for replacement heads and specific nozzle types |

### Lawn Seed (Colorado-adapted)
| Supplier | Notes |
|----------|-------|
| **Pawnee Buttes Seed** (Greeley, CO) | Colorado specialist; ships; best for high-plains Fescue blends |
| **High Country Gardens** | Denver-area retailer; drought-tolerant and native selections |
| **Home Depot / Lowe's** | Scotts or Pennington Fescue blends work; check for Colorado/mountain label |
| **Amazon** | Useful for smaller specialty seed quantities |
...
| Supplier | Notes |
|----------|-------|
| **Home Depot Tool & Truck Rental** (Littleton) | Plate compactor, sod cutter, angle grinder |
| **Sunbelt Rentals** (multiple Denver metro) | Better equipment for larger jobs; plate compactor, demo tools |
| **United Rentals** (Denver metro) | Same range; competitive daily rates |

---

*Last updated: May 2026. Cross-reference quantities with `backyard_project.md` § 6 before purchasing.*
